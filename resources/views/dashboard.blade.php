...
<div class="row">
    ...
    <div class="col-xl-4 col-lg-5">
        <div class="card shadow mb-4">
            ...
            <div
                class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Campsites Bookings</h6>
                <div class="dropdown no-arrow">
            ...
            <div class="card-body">
                ...
                <span class="mr-2">
                        <i class="fas fa-circle"></i> {{$label}}</span>                    
                @endforeach
                                 <!-- text-success ,text-info ,text-primary -->
                </div>
            </div>
        </div>
    </div>
...
<!-- /.container-fluid -->
    ...
    var _labels = {!! json_encode($labels, JSON_UNESCAPED_UNICODE) !!};
    var _data = {!! json_encode($data, JSON_UNESCAPED_UNICODE) !!};

    var _plabels = {!! json_encode($plabels, JSON_UNESCAPED_UNICODE) !!};
    var _pdata = {!! json_encode($pdata, JSON_UNESCAPED_UNICODE) !!};
</script>
