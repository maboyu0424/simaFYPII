        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link @if(!request()->is('admin/roomtype*')) collapsed @endif" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <!-- <i class="fas fa-fw fad fa-hotel"></i> -->
                    <i class="fab fa-buromobelexperte fa-pulse"></i>
                    <span>Roomtype</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link @if(!request()->is('admin/rooms*')) collapsed @endif" href="#" data-toggle="collapse" data-target="#roomMaster"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <!-- <i class="fas fa-fw fad fa-hotel"></i> -->
                    <i class="fas fa-fw fa-box fa-pulse"></i>
                    <span>Room</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link @if(!request()->is('admin/customer*')) collapsed @endif" href="#" data-toggle="collapse" data-target="#customerMaster"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <!-- <i class="fas fa-fw fad fa-hotel"></i> -->
                    <i class="fas fa-fw fa-users fa-pulse"></i>
                    <span>Customers</span>
                </a>
             ...
             <li class="nav-item">
                <a class="nav-link @if(!request()->is('admin/booking*')) collapsed @endif " href="#" data-toggle="collapse" data-target="#bookingMaster"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('admin/booking/create')}}">Add Booking</a>
